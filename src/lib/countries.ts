// Complete ISO 3166-1 country/territory list with E.164 dial codes.
// Flag emoji is computed from the ISO-2 code at render time.
...
export const COUNTRIES: Country[] = [
  ...
  { iso2: "FK", name: "Falkland Islands (Malvinas)", dialCode: "500" },
  ...
  { iso2: "VA", name: "Holy See (Vatican City State)", dialCode: "39" },
  ...
  { iso2: "KP", name: "Korea, Democratic People's Republic of", dialCode: "850" },
  { iso2: "KR", name: "Korea, Republic of", dialCode: "82" },
  { iso2: "KW", name: "Kuwait", dialCode: "965" },
  { iso2: "KG", name: "Kyrgyzstan", dialCode: "996" },
  { iso2: "LA", name: "Lao People's Democratic Republic", dialCode: "856" },
  ...
  { iso2: "FM", name: "Micronesia, Federated States of", dialCode: "691" },
  ...
  { iso2: "PS", name: "Palestine, State of", dialCode: "970" },
  ...
  { iso2: "RU", name: "Russian Federation", dialCode: "7" },
  ...
  { iso2: "SY", name: "Syrian Arab Republic", dialCode: "963" },
  ...
  { iso2: "VN", name: "Viet Nam", dialCode: "84" },
...
/** Convert ISO-2 to flag emoji via regional indicator code points. */
...
export function countryByIso2(iso2: string | null | undefined): Country | undefined {
  ...
  return COUNTRIES.find((c) => c.iso2 === u);
}
