...
export function HeroBookingBar() {
  ...
  return (
    <form
      ...
      className="mx-auto grid w-full max-w-5xl grid-cols-1 gap-2 rounded-2xl bg-white p-2 shadow-2xl ring-1 ring-black/5 md:grid-cols-[1.4fr_1fr_1fr_auto] md:items-center md:gap-0 md:rounded-full md:p-1.5"
    >
      {/* Location */}
