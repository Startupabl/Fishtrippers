...
INSERT INTO public.site_pages (slug, title, category, order_priority, status, description, content_html) VALUES
  ...
  ('about-us', 'About Lemonaidely', 'support_safety', 1, 'live',
   'All the juice, none of the seeds. Why Lemonaidely exists and how our human Aides help creators master AI.',
   '<p>In an era of AI noise, Lemonaidely is the filter. We believe that mastering the world''s most powerful creative tools shouldn''t be a bitter struggle — it should be a refreshing transformation.</p>'),
  ('contact', 'Contact Support', 'support_safety', 2, 'live',
   'Get in touch with the Lemonaidely team.',
   '<p>A full contact form is coming soon. For now, email us at hello@Lemonaidely and we''ll respond within one business day.</p>'),
  ...
  ('privacy-policy', 'Privacy Policy', 'legal', 1, 'live',
   'How Lemonaidely collects, uses, and protects your information.',
   '<p>In this early version of Lemonaidely, we only collect the information necessary to create your account and match you with an Aide. We do not sell your data to third parties.</p>'),
  ('terms-of-service', 'Terms of Service', 'legal', 2, 'live',
   'The rules that govern your use of Lemonaidely.',
   '<p>Lemonaidely is a place for respectful learning. We expect all Aides and learners to treat each other with patience and kindness.</p>'),
